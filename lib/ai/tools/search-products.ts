...
const productSearchSchema = z.object({
  query: z
    ...
    .default("")
    .describe(
      "Search term to find products by name, description, or category (e.g., 'headphones', 't-shirt', 'laptop')"
    ),
  category: z
    .string()
    .optional()
    .default("")
    .describe(
      "Filter by category slug (e.g., 'electronics', 'clothing', 'home-decor')"
    ),
  material: z
...
export const searchProductsTool = tool({
  description:
    "Search for products in the NCHUB store. Can search by name, description, or category, and filter by material, color, and price range. Returns product details including stock availability.",
