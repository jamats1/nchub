  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {/* Filter toggle button - 44px min touch target on mobile */}
        <Button
          variant="outline"
          size="sm"
          onClick={() => setFiltersOpen(!filtersOpen)}
          className="flex min-h-[44px] items-center gap-2 border-zinc-300 bg-white shadow-sm transition-all hover:bg-zinc-50 active:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:active:bg-zinc-800"
