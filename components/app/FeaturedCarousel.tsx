  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
      ...
      >
        ...
        {/* Navigation arrows - 44px touch targets on mobile */}
        <CarouselPrevious className="left-2 flex h-11 min-h-[44px] min-w-[44px] border-zinc-700 bg-zinc-800/80 text-white hover:bg-zinc-700 hover:text-white sm:left-8" />
        <CarouselNext className="right-2 flex h-11 min-h-[44px] min-w-[44px] border-zinc-700 bg-zinc-800/80 text-white hover:bg-zinc-700 hover:text-white sm:right-8" />
      </Carousel>
        ...
        <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 gap-2 sm:bottom-6">
          {Array.from({ length: count }).map((_, index) => (
            <button
              ...
              className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full p-3 transition-colors touch-manipulation"
