...
export function ProductInfo({ product }: ProductInfoProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Title */}
      <h1 className="mt-2 text-2xl font-bold text-zinc-900 sm:text-3xl dark:text-zinc-100">
        {product.name}
      </h1>

      {/* Price */}
      <p className="mt-4 text-xl font-semibold text-zinc-900 sm:text-2xl dark:text-zinc-100">
