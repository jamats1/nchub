...
export function AddToCartButton({
  ...
  return (
    <div
      className={cn(
        "flex min-h-[44px] h-11 w-full touch-manipulation items-center rounded-md border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900",
        className,
      )}
    >
      <Button
        variant="ghost"
        size="icon"
        className="h-full min-w-[44px] flex-1 rounded-r-none touch-manipulation"
      ...
      <Button
        variant="ghost"
        size="icon"
        className="h-full min-w-[44px] flex-1 rounded-l-none touch-manipulation disabled:opacity-20"
        onClick={handleAdd}
        disabled={isAtMax}
      >
