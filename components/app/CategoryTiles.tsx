...
export function CategoryTiles({
  ...
  return (
    <div className="relative">
      {/* Horizontal scrolling container - scroll-snap for mobile */}
      <div className="flex gap-4 overflow-x-auto py-4 pl-4 pr-4 sm:pl-6 sm:pr-6 lg:pl-8 lg:pr-8 scrollbar-hide snap-x snap-mandatory -webkit-overflow-scrolling-touch">
        {/* All Products tile */}
        <Link
          href="/"
          className={`group relative flex-shrink-0 snap-start overflow-hidden rounded-xl transition-all duration-300 ${
            !activeCategory
        ...
        >
          <div className="relative h-28 w-44 sm:h-32 sm:w-56 md:h-56 md:w-80">
            {/* Gradient background */}
