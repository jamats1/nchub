    ...
    <div className="flex h-full flex-col items-center justify-center text-center px-4">
      ...
      <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400 max-w-xs">
        {isSignedIn
          ...
          : "I can help you find anything by category, material, color, or price. Just ask!"}
      </p>
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {productSuggestions.map((suggestion) => (
            <button
              ...
              className="min-h-[44px] rounded-full border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-700 transition-colors touch-manipulation hover:bg-zinc-50 hover:border-amber-300 active:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700 dark:hover:border-amber-600 dark:active:bg-zinc-600"
            >
              {suggestion}
            </button>
          ))}
