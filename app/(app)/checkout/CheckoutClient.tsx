  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <Link
          href="/"
          className="inline-flex min-h-[44px] min-w-[44px] items-center text-sm text-zinc-500 hover:text-zinc-700 active:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200 dark:active:text-zinc-200"
        >
          <ArrowLeft className="mr-2 h-4 w-4" />
          Continue Shopping
        </Link>
        <h1 className="mt-4 text-2xl font-bold text-zinc-900 sm:text-3xl dark:text-zinc-100">
          Checkout
        </h1>
      </div>
